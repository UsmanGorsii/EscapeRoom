//Description : buttonValidationJoystickEditor : buttonValidationJoystick custom editor
#if (UNITY_EDITOR)
using UnityEngine;
...
[CustomEditor(typeof(buttonValidationJoystick))]
public class buttonValidationJoystickEditor : Editor {
	...
	void OnEnable () {
		...
		buttonValidationJoystick myScript = (buttonValidationJoystick)target; 
